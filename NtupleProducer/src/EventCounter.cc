...
//         Created:  Thu Dec  3 11:38:49 CET 2013
// $Id: EventCounter.cc,v 1.4 2014/05/21 14:54:26 cherepan Exp $
//
#include "LLRHiggsTauTau/NtupleProducer/interface/EventCounter.h"
...
EventCounter::EventCounter(const edm::ParameterSet& iConfig):
  CounterType_(iConfig.getUntrackedParameter<string>("CounterType","")),
  gensrc_  (consumes<edm::View<reco::GenParticle> >(iConfig.getParameter<edm::InputTag>("gensrccounter"))),
  GenEventInfo_(consumes<GenEventInfoProduct>(iConfig.getParameter<edm::InputTag>("GenEventInfo"))),
  DataMC_Type_(iConfig.getUntrackedParameter<string>("DataMCType","")),
  IsEmbed_(iConfig.getParameter<bool>("IsEmbed"))
{                           
  DataMCType DMT;
