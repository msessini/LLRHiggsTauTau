...
unsigned int DataMCType::GetType(TString name){
  ...
  if(name=="w_1qlnu")     return W_1qlnu;
  if(name=="w_2qlnu")    return W_2qlnu;
  if(name=="w_3qlnu")   return W_3qlnu;
  if(name=="w_4qlnu")   return W_4qlnu;
  if(name=="dy_ll")     return DY_ll;
  if(name=="dy_1qll") return DY_1qll;
  if(name=="dy_2qll") return DY_2qll;
  if(name=="dy_3qll") return DY_3qll;
  if(name=="dy_4qll") return DY_4qll;
  if(name=="dy_ll_10to50") return DY_ll_10to50;
  if(name=="dy_etau_embedded") return DY_etau_embedded;
